...
DEFAULT_SETTINGS = [
    ...
    ("travel_revenue_account_id", "", "integer", "travel_accounting", "حساب إيراد برامج الحج والعمرة"),
    ("travel_cost_account_id", "", "integer", "travel_accounting", "حساب تكلفة برامج الحج والعمرة"),
